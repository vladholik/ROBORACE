...
int magnet_time = 0;
int none_magnet_time = 0;

//double speed_read()
//{
//  hol = analogRead(ENCODER_PORT);
//  if ((hol > 900) or (hol < 800)){
//        magnet_time = time(NULL);
//        holl = 1;
//        while(holl != 0){
//          hol = analogRead(ENCODER_PORT);
//          if ((hol < 900) and (hol > 800))
//            holl = 0;
//          }
//        }
//  else{
//    none_magnet_time = time(NULL);}
//    holl = 1;
//        while(holl != 1){
//          hol = analogRead(ENCODER_PORT);
//          none_magnet_time = time(NULL);
...
//            holl = 1;
//          }
//          Serial.print(none_magnet_time - magnet_time)*4/1000;
//  
//}
